...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'ғᴀɪʀᴜᴢ㍐\n𝙹𝙰𝙽𝙶𝙰𝙽 𝙻𝚄𝙿𝙰 𝚂𝚄𝙱𝚂𝙲𝚁𝙸𝙱𝙴', body: wm, sourceUrl: 'https://youtube.com/channel/UC0kxCB-Uci5et_Tz9PcrB6w', thumbnail: data }}, options })
    }
